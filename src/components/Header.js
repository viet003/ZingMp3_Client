...
const Header = ({ setIsOpenStaticAudio }) => {
        ...
        <div className='flex justify-between w-full items-center'>
            ...
            <div className='flex gap-3'>
                ...
                <div className='h-10 w-10 bg-[#e6efef] flex justify-center items-center rounded-full relative cursor-pointer'>
                    ...
                    <div className={`${toggle ? "block" : "hidden"} absolute top-[120%] right-0 w-[300px] bg-[#e0ebeb] shadow-xl rounded-xl p-2 z-30`}>
                        {
                ...
                <div className='h-10 w-10 rounded-full bg-[#e6efef] flex justify-center items-center relative cursor-pointer'>
                    ...
                    <div className={`${toggleUser ? "block" : "hidden"} absolute text-[15px] top-[120%] right-0 w-[300px] bg-[#e0ebeb] shadow-xl rounded-xl p-3 z-30`}>
                        <div onClick={(e) => { e.preventDefault(); setToggleLogin(true); setToggleUser(prev => !prev) }} className='rounded-full flex items-center justify-center bg-primary w-full h-10 cursor-pointer text-gray-100 hover:bg-hover'>
                            <p>Đăng nhập</p>
                        </div>
